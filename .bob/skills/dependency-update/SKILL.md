...
checks = [
    # ("display name",  fetch_call),
    ("com.example:my-lib",   latest_stable("com.example", "my-lib")),
    ("plugin: org.foo",      latest_stable_gradle_plugin("org/foo/foo-gradle-plugin")),
    ("Gradle wrapper",       gradle_current()),
]

print(f"{'Dependency':<50} {'Latest stable'}")
print("-" * 65)
